...
const oauthServer: oauth.AuthorizationServer = {
...
const authorizeRedirect = async (
  ...
  const sessionStorageValues: SessionStorageValues = {
...
const callback = async (
  ...
  const oauth2Client: oauth.Client = {
...
export const appAuthConfig: AppAuthConfig = {
  appConfig,
